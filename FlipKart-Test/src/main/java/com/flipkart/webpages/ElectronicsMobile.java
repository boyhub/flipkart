...
//	Webelement initialization
	...
	By clearMoto = By.xpath("//div[@class='_3UZZGt'][contains(text(),'Motorola')]");
...
//	Clear brand filters method
	public void clearFiltersFromBrand() {
		new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(clearMoto));
		driver.findElement(clearMoto).click();
	}
...
//	PinCode change method
	public void enterDeliverPincode(String p) {
		...
		driver.findElement(By.cssSelector("input#pincodeInputId")).sendKeys(Keys.chord(Keys.CONTROL, "a", Keys.DELETE));
